...
export class MLDSAKeyDerivation {
	 ...
	 */
	static deriveKeyPair(seed: Uint8Array, path: string, securityLevel: MLDSASecurityLevel = 65): MLDSAKeyPair {
	 ...
	 */
	static getDerivationPath(accountPath: string, securityLevel: MLDSASecurityLevel = 65): string {
